    ...
    async function handleSignup(e: Event) {
        ...
        try {
            ...
            const res = await fetch(
                "https://extension-api-production-e194.up.railway.app/signup",
                {
                    method: "POST",
                    headers: {
            ...
            if (res.ok && result.success) {
                ...
                // Only send message if tsvscode exists
                if (typeof tsvscode !== "undefined") {
                    try {
                        ...
                        console.warn("VS Code message failed:", err);
                    }
                }
            } else {
